...
GPIO_PinState button_detector(int index)
{
	switch (index) {
		case 0:
			return HAL_GPIO_ReadPin(button_reset_GPIO_Port, button_reset_Pin);
			break;
		case 1:
			return HAL_GPIO_ReadPin(button_inc_GPIO_Port, button_inc_Pin);
			break;
		case 2:
			return HAL_GPIO_ReadPin(button_dec_GPIO_Port, button_dec_Pin);
			break;
		default:
			return NORMAL_STATE;
			break;
